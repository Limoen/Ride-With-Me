...
"; //this div is used to contain the results. Mostly used for styling.
    ...
    while($row = mysql_fetch_assoc($result)) {
        ...
        echo "<div data-demo-html='true'><ul data-role='listview' data-inset='true' class='ui-listview ui-listview-inset ui-corner-all ui-shadow'><li data-corners='false' data-shadow='false' data-iconshadow='true' data-wrapperels='div' data-icon='arrow-r' data-iconpos='right' data-theme='c' class='ui-btn ui-btn-icon-right ui-li-has-arrow ui-li ui-btn-up-c'><div class='ui-btn-inner ui-li'><div class='ui-btn-text'><a  href='rides.php?ride_id=" . $row['ride_id'] . "' class='ui-link-inherit'><p class='ui-li-aside ui-li-desc'>on " . $row['ride_date'] .  "<strong> at " . $row['ride_time'] . "</strong></p><h2 class='ui-li-heading'>" . $row['ride_city'] . " (" . $row['ride_country'] . ") - " . $row['ride_cityto'] . " (" . $row['ride_countryto'] . ")</h2><p class='ui-li-desc'><strong>From: </strong>" . $row['ride_street'] . " " . $row['ride_streetnumber'] . "</p><p class='ui-li-desc'><strong>To: </strong>" . $row['ride_streetto'] . " " . $row['ride_streetnumberto'] . "</p><p class='ul-li-desc'><img  src='img/steer.png'/>" . " " . $row['username'] . "</p></a></div></div></li></ul></div>";
